...
//             const selectedData = data.features.filter(feature => feature.properties.AREA_NAME === neighborhoodName)[0];
...
//                 theftFromMV: selectedData.properties.THEFTFROMMV_2023,
...
//                 window.crimeChartInstance.destroy(); // Destroy existing chart instance if present
//             }
...
fetch('/schcountdata')
    .then(response => response.json())
    .then(data => { // Extract the necessary data
